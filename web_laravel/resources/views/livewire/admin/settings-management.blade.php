<div class="h-full bg-[#f8fafc]" x-data="{ activeTab: @entangle('activeTab') }">
    <!-- Top Header -->
    <div class="bg-white border-b border-slate-100 px-10 py-5 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-800 tracking-tight leading-none">Pengaturan</h1>
            <p class="text-xs font-semibold text-slate-400 mt-1">MenuKu Restaurant Management</p>
        </div>
        
        <!-- User Profile -->
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-[#E8781A] flex items-center justify-center text-white font-black text-sm">
                A
            </div>
            <div class="text-left hidden sm:block">
                <span class="block text-sm font-black text-slate-800 leading-tight">Admin</span>
                <span class="block text-[10px] font-bold text-slate-400">Super Admin</span>
            </div>
    ...
    <!-- Navigation Tabs -->
    <div class="bg-white border-b border-slate-100 px-10 flex gap-8">
        <button @click="activeTab = 'informasi'" 
                ...
                class="py-4 border-b-2 text-sm transition outline-none">
            Informasi
        </button>
    ...
    @if (session()->has('success'))
        <div class="mx-10 mt-6 p-4 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center gap-3 text-emerald-800 animate-in fade-in slide-in-from-top duration-300">
    ...
    <div class="p-10">
        ...
        <div x-show="activeTab === 'informasi'" class="animate-in fade-in duration-300">
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="submit" 
                            class="px-8 py-3 bg-[#E8781A] text-white font-black rounded-full text-sm shadow-lg shadow-orange-500/20 hover:scale-[1.02] active:scale-95 transition-all">
                        Simpan Perubahan
                    </button>
                </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div>
                            ...
                            <input type="text" wire:model="site_name" 
                                   class="w-full px-6 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-[#E8781A] focus:border-[#E8781A] outline-none font-bold text-slate-800 transition duration-300">
                        ...
                        <div>
                            ...
                            <textarea wire:model="address" rows="3"
                                      class="w-full px-6 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-[#E8781A] focus:border-[#E8781A] outline-none font-bold text-slate-800 transition duration-300"></textarea>
        ...
        <div x-show="activeTab === 'pembayaran'" class="animate-in fade-in duration-300">
            <form wire:submit.prevent="save" class="space-y-8">
                <!-- Header -->
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-black text-slate-800 tracking-tight">Metode Pembayaran Aktif</h2>
                    <button type="submit" 
                            class="px-8 py-3 bg-[#E8781A] text-white font-black rounded-full text-sm shadow-lg shadow-orange-500/20 hover:scale-[1.02] active:scale-95 transition-all">
                        Simpan Perubahan
                    </button>
                ...
                <div class="bg-white border border-slate-100 rounded-[2.5rem] p-10 shadow-sm space-y-6">
                    <!-- 1. Tunai -->
                ...
                <div class="bg-white border border-slate-100 rounded-[2.5rem] p-10 shadow-sm space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        @for ($i = 0; $i < 4; $i++)
                            <div class="relative bg-slate-50 border border-slate-150 rounded-2xl px-5 py-4 flex items-center gap-2">
